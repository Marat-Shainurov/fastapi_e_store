...
from .crud_products import get_product, get_products, add_product, put_product, destroy_product
...
__all__ = [
    ...
    'authenticate_user',
    'get_product', 'get_products', 'add_product', 'put_product', 'destroy_product',
]
